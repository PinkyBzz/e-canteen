...
<div class="max-w-2xl mx-auto">
    <div class="bg-white/70 backdrop-blur-xl border border-white/80 rounded-3xl shadow-sm p-6 md:p-8">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <h2 class="text-lg font-semibold text-zinc-900">Form Tambah Menu</h2>
        </div>
        ...
        <form method="POST" action="{{ route('admin.menus.store') }}" enctype="multipart/form-data" class="space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="category" value="{{ old('category') }}" required
                        placeholder="Makanan / Minuman" list="categories"
                        class="w-full rounded-xl border border-zinc-200 bg-white/60 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-900/20 focus:border-zinc-400 transition">
            ...
            <div>
                ...
                <textarea name="description" rows="3" placeholder="Deskripsi singkat menu..."
                    class="w-full rounded-xl border border-zinc-200 bg-white/60 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-zinc-900/20 focus:border-zinc-400 transition resize-none">{{ old('description') }}</textarea>
            </div>
